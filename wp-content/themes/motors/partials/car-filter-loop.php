	...
	<a href="<?php the_permalink(); ?>" class="rmv_txt_drctn xx">
		<div class="image">
			<?php if(has_post_thumbnail()): ?>
				<?php $img = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'stm-img-350-260'); ?>
				<?php $img_2x = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'stm-img-796-466'); ?>
				<?php echo wp_get_attachment_image( get_post_thumbnail_id( get_the_ID() ), 'stm-img-350-260', false, array( 'data-retina' => $img_2x[0], 'alt' => get_the_title() ) ); ?>
			<?php else: ?>
