	...
	>
		...
		<div class="image">
			...
			<?php if(!empty($show_compare) and $show_compare): ?>
				<div class="stm-listing-compare <?php echo esc_attr($car_already_added_to_compare); ?>" data-id="<?php echo esc_attr(get_the_id()); ?>" data-title="<?php echo stm_generate_title_from_slugs(get_the_id(),false); ?>">
