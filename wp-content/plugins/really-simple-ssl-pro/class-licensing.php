...
public function show_notice_license(){
 ...
 if (!$this->license_is_valid() && !$dismissed) { ?>
	 <?php if (!is_multisite()) {?>
		    ...
		    <p>
		      <?php echo __("You haven't activated your Really Simple SSL pro license yet. To get all future updates, enter your license on the settings page.","really-simple-ssl-pro");?>
					<a href="options-general.php?page=rlrsssl_really_simple_ssl&tab=license"><?php echo __("Go to the settings page","really-simple-ssl-pro");?></a>
						...
						<td>
							...
							<?php if( false !== $license ) { ?>
										<?php if( $status && $status == 'valid' ) { ?>
											...
											<input type="submit" class="button-secondary" name="rsssl_pro_license_deactivate" value="<?php _e('Deactivate License'); ?>"/>
										<?php } else {?>
											<input type="submit" class="button-secondary" name="rsssl_pro_license_activate" value="<?php _e('Activate License'); ?>"/>
